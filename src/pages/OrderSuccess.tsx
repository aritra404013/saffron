...
const OrderSuccess = () => (
  <div style={{
    ...
    <div className="anim-fade-up" style={{ textAlign: "center", maxWidth: 400 }}>
      <div style={{
        width: 100, height: 100, borderRadius: "50%", margin: "0 auto var(--sp-6)",
        background: "linear-gradient(135deg, var(--success), #047857)",
        display: "flex", alignItems: "center", justifyContent: "center",
        fontSize: "2.8rem", boxShadow: "0 12px 40px rgba(16,185,129,.35)",
        animation: "pop .5s var(--ease) both",
      }}>🎉</div>
      <h1 style={{ fontWeight: 900, fontSize: "2rem", letterSpacing: "-.04em", marginBottom: "var(--sp-3)" }}>
        Order Confirmed!
      </h1>
      <p style={{ color: "var(--text-3)", lineHeight: 1.6, marginBottom: "var(--sp-8)", fontSize: ".95rem" }}>
